...
def register_handlers_fsm_mentor(dp: Dispatcher):
    ...
    dp.register_message_handler(load_username, state=FSMMentor.username)
    dp.register_message_handler(load_direction, state=FSMMentor.direction)
    dp.register_message_handler(load_grup, state=FSMMentor.grup)
    dp.register_message_handler(load_available, state=FSMMentor.available)
